const CustomField = require("../model/custom-field");
...
exports.customFieldList = function (req, res, next) {
    try {
        CustomField.find({}, "_id fieldName fieldType").then((customFields) => {
...
exports.customFieldUpdate = function (req, res, next) {
    let updateCustomField = new CustomField({
        _id: req.body._id,
        fieldName: req.body.fieldName,
        fieldType: req.body.fieldType
    });
